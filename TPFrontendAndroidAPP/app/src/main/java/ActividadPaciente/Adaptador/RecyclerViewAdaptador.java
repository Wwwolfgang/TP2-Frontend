...
public class RecyclerViewAdaptador extends RecyclerView.Adapter<RecyclerViewAdaptador.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.cedula.setText("Cedula: "+Integer.toString(pdata.get(position).getCedula()));
        holder.email.setText("Email: "+ pdata.get(position).getEmail());
        holder.telefono.setText("Telefono: " + Integer.toString(pdata.get(position).getTelefono()));
